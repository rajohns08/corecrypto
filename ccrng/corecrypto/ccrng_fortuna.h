...
typedef lck_grp_t *ccrng_fortuna_lock_group;
typedef lck_mtx_t *ccrng_fortuna_lock_mutex;

struct ccrng_fortuna_lock_ctx {
    ccrng_fortuna_lock_group group;
    ccrng_fortuna_lock_mutex mutex;
};
...
typedef pthread_mutex_t ccrng_fortuna_lock_mutex;
...
typedef os_unfair_lock ccrng_fortuna_lock_mutex;
...
struct ccrng_fortuna_ctx {
    ...
    struct ccrng_fortuna_lock_ctx lock;
