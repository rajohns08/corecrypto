...
K_XMM_AR:
    ...
    .p2align  2
    .code   16
    .thumb_func _AccelerateCrypto_SHA1_compress
...
_AccelerateCrypto_SHA1_compress:
    ...
    mov     r12, sp
	ands	r12, r12, #15	// number of bytes to align to 16-byte boundary
    it      eq
...
#define	stack_size (16*4)		// circular buffer W0-W3
	...
	mov		HASH_PTR, ctx
	mov		BUFFER_PTR, buf
    // point K_BASE to the table
    ldr     K_BASE, L_table1
L_table0:
    mov     r12, pc
    ldr     K_BASE, [r12, K_BASE]
...
L_table1:
    ...
    .p2align  2
L_Tab$non_lazy_ptr:
    .indirect_symbol        K_XMM_AR 
    .long   0




#endif  // #if (defined(__arm__) && defined(__ARM_NEON__))
