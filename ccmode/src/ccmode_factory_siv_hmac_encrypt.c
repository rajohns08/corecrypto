...
void ccmode_factory_siv_hmac_encrypt(struct ccmode_siv_hmac *siv_hmac,
                                     const struct ccdigest_info *digest,
                                     const struct ccmode_ctr *ctr)
{
    struct ccmode_siv_hmac siv_hmac_encrypt = {
        ...
        .crypt = ccmode_siv_hmac_encrypt,
        .reset = ccmode_siv_hmac_reset,
        .hmac_digest = digest,
        .ctr = ctr };
    *siv_hmac = siv_hmac_encrypt;    // Copy by value
}
