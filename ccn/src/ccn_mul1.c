/* Copyright (c) (2012,2013,2014,2015,2016,2019,2020) Apple Inc. All rights reserved.
 *
...
#if CCN_MUL1_ASM
cc_unit ccn_mul1_asm(cc_size n, cc_unit *r, const cc_unit *s, cc_unit v);

CC_INLINE bool ccn_use_mul1_assembly()
{
